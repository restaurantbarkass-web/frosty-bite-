      ...
      <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center py-4">
            ...
            {/* Title / Badge status */}
            <span className="text-[10px] bg-orange-500/10 text-primary border border-orange-500/20 px-3 py-1 rounded-full uppercase font-black tracking-widest leading-none mb-3">
              Feature Cooking
            </span>
            <h3 className="text-2xl font-black tracking-tight leading-none mb-4">SECURE FUNDS LOCK</h3>
