...
/**
 * A performance-optimized image component for the Frosty Bite application.
 * Features:
 * - Native lazy loading (loading="lazy")
 * - Fetch priority for hero images (fetchpriority="high")
 * - Aspect ratio stabilization (prevents layout shift)
  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        // @ts-ignore - fetchpriority is a valid attribute but missing in standard types
