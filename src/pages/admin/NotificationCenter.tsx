    ...
    <div className="space-y-6 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 sm:p-6 rounded-3xl border border-stone-200/80 shadow-xs">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-[#E76A54]/10 border border-[#E76A54]/20 flex items-center justify-center text-[#E76A54]">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={loading}
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#FAF8F5] hover:bg-stone-100 text-stone-700 border border-stone-200 text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white p-4 sm:p-5 rounded-3xl border border-stone-200/80 shadow-xs">
          ...
          <div className="text-2xl sm:text-3xl font-black text-stone-900">{analytics.activeTokens}</div>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-3xl border border-stone-200/80 shadow-xs">
          ...
          <div className="text-2xl sm:text-3xl font-black text-stone-900">{analytics.totalSent}</div>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-3xl border border-stone-200/80 shadow-xs">
          ...
          <div className="text-2xl sm:text-3xl font-black text-stone-900">{analytics.openRate}</div>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-3xl border border-stone-200/80 shadow-xs">
          ...
          <div className="text-2xl sm:text-3xl font-black text-emerald-600">99.2%</div>
          <p className="text-[11px] text-stone-500 mt-1 font-medium">
      ...
      {/* Sub-Navigation Tabs */}
      <div className="flex items-center gap-2 border-b border-stone-200 pb-2 overflow-x-auto scrollbar-hide">
        {[
          { id: 'broadcast', label: '📢 FCM Broadcast Campaign' },
          { id: 'simulator', label: '⚡ Order FCM Simulator' },
          { id: 'alerts', label: '🔔 Store Incoming Alerts' },
          { id: 'tokens', label: '📱 Registered Device Tokens' },
        ].map((tab) => (
          <button
            key={tab.id}
            type="button"
            ...
            className={cn(
              "px-4 py-2.5 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all whitespace-nowrap cursor-pointer",
              activeSubTab === tab.id
                ? "bg-[#E76A54] text-white shadow-md shadow-[#E76A54]/25"
      ...
      {activeSubTab === 'broadcast' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Campaign Form */}
          <div className="lg:col-span-7 bg-white p-5 sm:p-6 rounded-3xl border border-stone-200/80 shadow-xs space-y-4">
            <div className="border-b border-stone-100 pb-3.5">
              <h2 className="text-base font-bold text-stone-900 uppercase tracking-tight flex items-center gap-2">
            ...
            <form onSubmit={handleSendCampaign} className="space-y-4">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        campaignAudience === aud.id
                          ? "bg-[#E76A54]/10 border-[#E76A54] text-[#E76A54] font-bold"
                          : "bg-[#FAF8F5] border-stone-200 text-stone-600 hover:text-stone-900 hover:bg-stone-100"
                      )}
                    >
                      {aud.label}
                    </button>
              ...
              {campaignAudience === 'user' && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-[#FAF8F5] border border-stone-200 rounded-xl text-sm text-stone-900 focus:outline-none focus:border-[#E76A54]"
                  />
                </div>
              )}
              ...
              <div>
                  ...
                  <div className="flex gap-1">
                    {['🥐', '🍰', '🔥', '🎉', '⚡', '👑'].map((emoji) => (
                      <button
                        ...
                        className="px-1.5 py-0.5 rounded bg-stone-100 hover:bg-stone-200 text-xs text-stone-700 cursor-pointer"
                      >
                        {emoji}
                      </button>
                    ))}
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-[#FAF8F5] border border-stone-200 rounded-xl text-sm text-stone-900 font-semibold focus:outline-none focus:border-[#E76A54]"
                  required
                />
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-[11px] text-stone-400">{campaignMessage.length} chars</span>
                </div>
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-[#FAF8F5] border border-stone-200 rounded-xl text-sm text-stone-900 focus:outline-none focus:border-[#E76A54] resize-none"
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. BAKE20"
                    className="w-full px-4 py-2.5 bg-[#FAF8F5] border border-stone-200 rounded-xl text-sm text-stone-900 font-mono uppercase font-bold focus:outline-none focus:border-[#E76A54]"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-2xl bg-[#E76A54] hover:bg-[#d55b45] text-white font-bold text-xs uppercase tracking-widest shadow-md shadow-[#E76A54]/25 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
                <Send size={16} />
          ...
          <div className="lg:col-span-5 bg-white p-5 sm:p-6 rounded-3xl border border-stone-200/80 shadow-xs flex flex-col justify-between">
            <div>
              <div className="border-b border-stone-100 pb-3.5 mb-4">
                ...
                <p className="text-xs text-stone-400 mt-0.5">Real-time simulation of customer push banner</p>
              </div>

              {/* Phone Frame Mockup */}
              <div className="max-w-xs mx-auto bg-stone-900 rounded-[2.5rem] p-4 border-4 border-stone-800 shadow-xl relative">
                {/* Speaker Notch */}
                <div className="w-20 h-4 bg-stone-800 rounded-full mx-auto mb-6" />

                {/* Lockscreen Time */}
                <div className="text-center mb-6">
                  <div className="text-3xl font-light text-white tracking-tight">09:41</div>
                  <div className="text-[10px] text-stone-400 font-medium uppercase tracking-wider">Thursday, September 5</div>
                </div>
                ...
                <motion.div 
                  ...
                  className="bg-stone-800/95 backdrop-blur-xl border border-white/10 rounded-2xl p-3.5 shadow-xl space-y-1.5"
                >
            ...
            <div className="mt-4 p-3 bg-[#FAF8F5] rounded-xl border border-stone-200 text-center">
      ...
      {activeSubTab === 'simulator' && (
        <div className="bg-white p-5 sm:p-6 rounded-3xl border border-stone-200/80 shadow-xs space-y-5">
          <div className="border-b border-stone-100 pb-3.5">
            <h2 className="text-base font-bold text-stone-900 uppercase tracking-tight flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-xl">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-[#FAF8F5] border border-stone-200 rounded-xl text-sm text-stone-900 font-mono font-bold focus:outline-none focus:border-[#E76A54]"
              />
            </div>
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-stone-600 mb-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-[#FAF8F5] border border-stone-200 rounded-xl text-sm text-stone-900 font-medium focus:outline-none focus:border-[#E76A54]"
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {[
                { status: 'confirmed', label: '1. Order Confirmed', desc: 'Payment verified & queued', icon: '✅', color: 'border-blue-200 hover:border-blue-400 bg-blue-50/40' },
                { status: 'preparing', label: '2. Baking in Progress', desc: 'Chef preparing in kitchen oven', icon: '👩‍🍳', color: 'border-amber-200 hover:border-amber-400 bg-amber-50/40' },
                { status: 'out_for_delivery', label: '3. Out for Delivery', desc: 'Courier rider on the road', icon: '🛵', color: 'border-purple-200 hover:border-purple-400 bg-purple-50/40' },
                { status: 'delivered', label: '4. Order Delivered', desc: 'Fresh at customer doorstep', icon: '🍰', color: 'border-emerald-200 hover:border-emerald-400 bg-emerald-50/40' },
                { status: 'cancelled', label: '5. Order Support Alert', desc: 'Custom modification or update', icon: '⚠️', color: 'border-rose-200 hover:border-rose-400 bg-rose-50/40' },
              ].map((btn) => (
                <button
                  key={btn.status}
                  type="button"
                  ...
                  className={cn(
                    "p-4 rounded-2xl text-left border transition-all cursor-pointer hover:shadow-xs",
                    btn.color,
                    simStatus === btn.status && "ring-2 ring-[#E76A54] border-transparent"
                  )}
                >
                  ...
                  <p className="text-xs text-stone-500 font-medium">{btn.desc}</p>
                </button>
              ))}
            </div>
          </div>
              ...
              <div key={alert.id} className="py-3.5 flex items-start justify-between gap-4">
                <div className="flex items-start gap-3">
                  <div className={cn(
                    ...
                    alert.severity === 'success' ? "bg-emerald-50 text-emerald-700 border border-emerald-200" :
                    "bg-blue-50 text-blue-700 border border-blue-200"
                  )}>
                    {alert.type === 'order' ? '🍕' : alert.type === 'payment' ? '💳' : alert.type === 'inventory' ? '📦' : '⭐'}
                  </div>
                  <div>
                    <h3 className="text-sm font-bold text-stone-900">{alert.title}</h3>
                    <p className="text-xs text-stone-500 mt-0.5">{alert.message}</p>
                    <span className="text-[10px] text-stone-400 font-medium block mt-1">{alert.timestamp}</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="bg-white p-5 sm:p-6 rounded-3xl border border-stone-200/80 shadow-xs space-y-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs text-stone-700">
              <thead className="bg-[#FAF8F5] text-stone-500 uppercase font-bold text-[10px] tracking-wider border-b border-stone-200">
                <tr>
              ...
              <tbody className="divide-y divide-stone-100">
                {registeredTokens.map((item) => (
                  <tr key={item.id} className="hover:bg-stone-50 transition-colors">
                    <td className="p-3 font-semibold text-stone-900">{item.browser}</td>
                    <td className="p-3">
                      <span className="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase bg-stone-100 text-stone-600">
                        {item.platform}
                      </span>
                    </td>
                    <td className="p-3 font-mono text-stone-600">{item.user_id}</td>
                    <td className="p-3 font-mono text-stone-400 truncate max-w-[150px]">{item.token}</td>
                    <td className="p-3 text-stone-400">{item.last_active}</td>
                    <td className="p-3 text-right">
                      <button
                        type="button"
                        onClick={() => handleTestTokenPing(item)}
                        className="px-2.5 py-1 rounded-lg bg-[#E76A54]/10 hover:bg-[#E76A54]/20 text-[#E76A54] font-bold text-[10px] uppercase tracking-wider transition-colors cursor-pointer"
                      >
                        Ping Device
                      </button>
                    </td>
